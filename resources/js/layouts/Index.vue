        ...
        <div class="container-fluid">
                    ...
                    <div class="dropdown dropdown-cart">
                        ...
                        <div class="dropdown-menu">
                            ...
                            <div class="total_drop">
                                ...
                                <a href="shop-cart.html" class="btn_1 outline"
                                    >View Cart</a
                                ><a href="shop-checkout.html" class="btn_1"
                                    >Checkout</a
                                >
                            </div>
                        </div>
            ...
            <nav class="main-menu">
                ...
                <ul>
                    ...
                    <li>
                        <a href="reservations.html" class="btn_top"
                            >Reservations</a
                        >
                    </li>
                </ul>
                ...
                <div class="col-xl-3 col-lg-6 col-md-6 col-sm-6">
                    <div class="footer_wp">
                        ...
                        <p>
                            ...
                            ><br /><a href="#0">reservations@Foores.com</a>
                        </p>
                    </div>
                </div>
                <div class="col-xl-3 col-lg-6 col-md-6 col-sm-6">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <p>
                        ...
                        <strong>nec quod novum accumsan</strong>, mei ludus
                        tamquam dolores id. No sit debitis meliore postulant,
                        per ex prompta alterum sanctus, pro ne quod dicunt
                        sensibus.
                    </p>
                    <p>
                        Lorem ipsum dolor sit amet, in porro albucius qui, in
                        ...
                        sanctus, pro ne quod dicunt sensibus. Lorem ipsum dolor
                        sit amet, <strong>in porro albucius qui</strong>, in nec
                        quod novum accumsan, mei ludus tamquam dolores id. No
                        sit debitis meliore postulant, per ex prompta alterum
