                        ...
                        <div class="filter_type">
                            ...
                            <ul>
                                <li>
                                    <label class="container_check">
                                        Tuyệt vời(4.5+)
                                        <small>{{ getRatingCount(4.5) }}</small>
                                        <input
                                            type="checkbox"
                                ...
                                <li>
                                    <label class="container_check">
                                        Tốt(3.5+)
                                        <small>{{ getRatingCount(3.5) }}</small>
                                        <input
                                            type="checkbox"
                            ...
                            <ul>
                                ...
                                >
                                    <label class="container_check">
                                        ...
                                        <input
                                            type="checkbox"
                                            @change="filterByPriceRange(range)"
                                        />
                                        <span class="checkmark"></span>
                                    </label>
                                </li>
        ...
        <div class="container margin_60_40">
            <div class="row small-gutters">
                ...
                >
                    <div class="grid_item">
                        <figure>
                            <span class="ribbon off" v-if="product.price_sale">
                                -{{
                                    (
                        ...
                        <div
                            class="rating"
                            v-if="product.total_rating && product.total_number"
                        >
                            <i
                                class="icon_star"
                                v-for="n in 5"
                        ...
                        <div class="price_box">
                            ...
                            >
                            <span class="old_price" v-if="product.price_sale"
