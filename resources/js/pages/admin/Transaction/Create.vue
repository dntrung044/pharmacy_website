    ...
    <AuthenticatedLayout>
        ...
        <SectionMain>
            ...
            <CardBox
                form
                @submit.prevent="
                    form.post(route('admin.menu.item.store', menu.id))
                "
            >
                <FormField
                    label="Name"
                ...
                >
                    ...
                    >
                        <div class="item-list">
                            ...
                            <em class="placeholder">/home</em> or an external
                            URL such as
                            <em class="placeholder">http://example.com</em>. Add
                            prefix <em class="placeholder">&lt;admin&gt;</em> to
                            link for admin page. Enter
                            <em class="placeholder">&lt;nolink&gt;</em> to
                            display link text only.
                        </div>
                        <div
                            class="text-red-400 text-sm"
                            v-if="form.errors.uri"
                        >
                            {{ form.errors.uri }}
                        </div>
                    </FormControl>
                ...
                >
                    ...
                    >
                        ...
                        <div>
                            The maximum depth for a link and all its children is
                            fixed. Some menu links may not be available as
